...
{
    public partial class Audit_GAAP_Basis : Form
    {
        public Audit_GAAP_Basis()
        {
            InitializeComponent();
        }
        ...
        private void Generate_Letter_button_Click(object sender, EventArgs e)
            {
                ...
                if (MessageBox.Show("Please Confirm the following information is correct ", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    if (RatesYes.Checked && SupplementaryInclude.Checked)
                        {
                            try
                            {
                                document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Audit-GAAP Basis\Audit -GAAP Basis-450-Supplementary.docx");
                            ...
                            try
                            {
                                document = application.Documents.Add(Template: @"S:\Shared\wnorales\Audit-GAAP Basis\Audit -GAAP Basis-450-Supplementary.docx");
                                document.GrammarChecked = true;
                                document.SpellingChecked = true;
                                application.Visible = true;
                            }
                    ...
                    if (RatesNo.Checked && SupplementaryInclude.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Audit-GAAP Basis\Audit -GAAP Basis-495-Supplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Audit-GAAP Basis\Audit -GAAP Basis-495-Supplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    else if (RatesYes.Checked && SupplementaryRemove.Checked)
                        {
                            try
                            {
                                document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Audit-GAAP Basis\Audit -GAAP Basis-450-NoSupplementary.docx");
                                document.GrammarChecked = true;
                                document.SpellingChecked = true;
                                application.Visible = true;
                            }
                            ...
                            try
                            {
                                document = application.Documents.Add(Template: @"S:\Shared\wnorales\Audit-GAAP Basis\Audit-GAAP Basis-450-NoSupplementary.docx");
                                document.GrammarChecked = true;
                                document.SpellingChecked = true;
                                application.Visible = true;
                            }
                    ...
                    else if (RatesNo.Checked && SupplementaryRemove.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Audit-GAAP Basis\Audit -GAAP Basis-495-NoSupplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Audit-GAAP Basis\Audit-GAAP Basis-495-NoSupplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    else if (RatesOther.Checked && SupplementaryInclude.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Audit-GAAP Basis\Audit -GAAP Basis-Other-Supplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Audit-GAAP Basis\Audit -GAAP Basis-Other-Supplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    else if (RatesOther.Checked && SupplementaryRemove.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Audit-GAAP Basis\Audit -GAAP Basis-Other-NoSupplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Audit-GAAP Basis\Audit -GAAP Basis-Other-NoSupplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
        ...
        private void RatesYes_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        private void RatesNo_CheckedChanged_1(object sender, EventArgs e)
        {
            AmountBox.Visible = false;
            RetainerFeild.Visible = false;
        ...
        private void Enter_Retainer(object sender, EventArgs e)
        {
        ...
        private void Leave_Retainer(object sender, EventArgs e)
        {
        ...
        private void Open_Template_Click(object sender, EventArgs e)
        {
            var application = new Microsoft.Office.Interop.Word.Application();
            var document = new Microsoft.Office.Interop.Word.Document();
            document = application.Documents.Open(@"C:\Users\Will Norales\Downloads\Audit-GAAP Basis\Audit -GAAP Basis-450-Supplementary.docx");
