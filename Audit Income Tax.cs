...
{
    public partial class Audit_Income_Tax : Form
    {
        public Audit_Income_Tax()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Please Confirm the following information is correct ", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                try
                {
                    ...
                    if (RatesYes.Checked && SupplementaryInclude.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Audit Income Tax Basis\Audit_Income Tax Basis_450_Supplementary.docx");
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Audit Income Tax Basis\Audit_Income Tax Basis_450_Supplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    else if (RatesNo.Checked && SupplementaryInclude.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Audit Income Tax Basis\Audit_Income Tax Basis_495_Supplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Audit Income Tax Basis\Audit_Income Tax Basis_495_Supplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    else if (RatesOther.Checked && SupplementaryInclude.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Audit Income Tax Basis\Audit_Income Tax Basis_SupplementaryRates.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Audit Income Tax Basis\Audit_Income Tax Basis_SupplementaryRates.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    else if (RatesYes.Checked && SupplementaryRemove.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Audit Income Tax Basis\Audit_Income Tax Basis_450NoSupplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Audit Income Tax Basis\Audit_Income Tax Basis_450NoSupplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    else if (RatesNo.Checked && SupplementaryRemove.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Audit Income Tax Basis\Audit_Income Tax Basis_495NoSupplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Audit Income Tax Basis\Audit_Income Tax Basis_495NoSupplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    else if (RatesOther.Checked && SupplementaryRemove.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Audit Income Tax Basis\Audit_Income Tax Basis_NoSupplementaryRates.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Audit Income Tax Basis\Audit_Income Tax Basis_NoSupplementaryRates.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    try
                    {
                        ...
                        foreach (Microsoft.Office.Interop.Word.Field field in document.Fields)
                        {
                            ...
                            else if (field.Code.Text.Contains("State"))
                            {
                                ...
                                application.Selection.TypeText(state1);
                            }
                            else if (field.Code.Text.Contains("CompanyEnd"))
                            {
                                ...
                                try
                                {
                                    ...
                                    DateTime dt3 = Convert.ToDateTime(CompanyEnd);
                                    string CompanyEnd2 = dt3.ToString("MMMM d, yyyy");
                                    application.Selection.TypeText(CompanyEnd2);
                                }
                            ...
                            else if (field.Code.Text.Contains("inventories"))
                            {
                                if (PhysicalExistenceInclude.Checked)
                                {
                                    field.Select();
                                    string inventories = "tests of the physical existence of inventories,";
                                    application.Selection.TypeText(inventories);
                                }
                                else if (PhysicalExistenceRemove.Checked)
                                {
                                    field.Delete();
                                }
                            }
                            ...
                            else if (field.Code.Text.Contains("startdate"))
                            {
                                ...
                                try
                                {
                                    ...
                                    string start1 = dt.ToString("MMMM d, yyyy");
                                    application.Selection.TypeText(start1);
                                }
                                catch (Exception ex) when (ex is System.FormatException)
                                {
                                    if (ex is System.FormatException)
                            ...
                            else if (field.Code.Text.Contains("Enddate"))
                            {
                                ...
                                try
                                {
                                    ...
                                    string end1 = dt1.ToString("MMMM d, yyyy");
                                    application.Selection.TypeText(end1);
                                }
                                catch (Exception ex) when (ex is System.FormatException)
                                {
                                    if (ex is System.FormatException)
        ...
        private void Audit_Income_Tax_Load(object sender, EventArgs e)
        {
        ...
        private void FeeOther_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void RetainerEnter(object sender, EventArgs e)
        {
        ...
        private void RetainerLeave(object sender, EventArgs e)
        {
