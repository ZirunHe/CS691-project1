...
{
    public partial class Audit_CO_OP_GAAP_Basis : Form
    {
        public Audit_CO_OP_GAAP_Basis()
        {
            InitializeComponent();
        }

        private void Audit_of_Co_Op_GAAP_Basis_Load(object sender, EventArgs e)
        {
        ...
        private void Generate_Letter_button_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Please Confirm the following information is correct ", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                try
                {
                    ...
                    string DesignationKertzner = "CPA/ABV, CVA";     // There is no signature 12/7/2018
                    string DesignationWillinger = "CPA, JD"; // There is no signature 12/7/2018
                    string DesignationEller = "CPA, JD";    // There is no signature 12/7/2018
                    string DesignationBibas = "CPA";        // There is no signature 12/7/2018
                    string DesignationMarx = "CPA";
                    string DesignationLange = "CPA";
                    string DesignationWeingarten = "CPA";        // There is no signature 12/7/2018
                    string DesignationBloom = "CPA";
                    string DesignationGreenbaum = "CPA, CFP, PFS";  // There is no signature 12/7/2018




                    if (RatesYes.Checked && SupplementaryRemove.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Audit Of CO-OP Gaap Basis\Audit of Co-op_450_NoSupplmentary.docx");
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Audit Of CO-OP Gaap Basis\Audit of Co-op_450_NoSupplmentary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    else if (RatesYes.Checked && SupplementaryInclude.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Audit Of CO-OP Gaap Basis\Audit of Co-op_450Supplmentary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Audit Of CO-OP Gaap Basis\Audit of Co-op_450Supplmentary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    else if (RatesNo.Checked && SupplementaryInclude.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Audit Of CO-OP Gaap Basis\Audit of Co-op_495Supplmentary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Audit Of CO-OP Gaap Basis\Audit of Co-op_495Supplmentary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    else if (RatesNo.Checked && SupplementaryRemove.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Audit Of CO-OP Gaap Basis\Audit of Co-op_495_NoSupplmentary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Audit Of CO-OP Gaap Basis\Audit of Co-op_495_NoSupplmentary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    try
                    {
                        ...
                        foreach (Microsoft.Office.Interop.Word.Field field in document.Fields)
                        {
                            ...
                            else if (field.Code.Text.Contains("Management Company"))
                            {
                                field.Select();
                                string Management = Management_Company.Text;
                                application.Selection.TypeText(Management);
                            }
                            ...
                            else if (field.Code.Text.Contains("StartDate"))
                            {
                                ...
                                try
                                {
                                    string StartDate = FirstInstallment.Text;
                                    DateTime dt = Convert.ToDateTime(StartDate);
                                    string StartDate2 = dt.ToString("MMMM d, yyyy");
                                    application.Selection.TypeText(StartDate2);
                                }
                                ...
                                catch (Exception ex) when (ex is System.FormatException)
                                {
                                    if (ex is System.FormatException)
                                    {
                                        string StartDate = YearEnd.Text;
                                        application.Selection.TypeText(StartDate);
                            ...
                            else if (field.Code.Text.Contains("EndDate"))
                            {
                                ...
                                try
                                {
                                    string EndDate = LastInstallment.Text;
                                    DateTime dt = Convert.ToDateTime(EndDate);
                                    string EndDate2 = dt.ToString("MMMM d, yyyy");
                                    application.Selection.TypeText(EndDate2);
                                }
                                ...
                                catch (Exception ex) when (ex is System.FormatException)
                                {
                                    ...
                                    {
                                        string EndDate = LastInstallment.Text;
                                        application.Selection.TypeText(EndDate);
                            ...
                            {
                                field.Select();
                                string amount = Monthly_Fee.Text;
                                application.Selection.TypeText("$" + amount);

                            }

                   
                            else if (field.Code.Text.Contains("Form 1098"))
                            {
                            ...
                            else if (field.Code.Text.Contains("Forms"))
                            {
                                ...
                                {
                                    field.Select();
                                    string formsyes = "Prepare Form 1098’s.";
                                    application.Selection.TypeText(formsyes);

                                }


                                else if (FornsNo.Checked)
                                {
                                    field.Select();
                                    string formsno = "Calculate and prepare the underlying data for your managing agent to use in the preparation of Forms 1098.";
                                    application.Selection.TypeText(formsno);
                                }


                            }

                            else if (field.Code.Text.Contains("1098"))
                            {

                                if (FormsYes.Checked)
                                {
                                    field.Select();
                                    string forms2 = "Form 1098 – Mortgage Interest Statements will be billed at $10.00 per form.";
                                    application.Selection.TypeText(forms2);
                            ...
                            else if (field.Code.Text.Contains("RetainerSection"))
                            {
                                ...
                                {
                                    RetainerSection = " with the retainer. ";
                                    application.Selection.TypeText(RetainerSection);
                                }
                            }
                        }
        ...
        private void Enter_Fee(object sender, EventArgs e)
        {
            if(Feebox.Text == "Please Enter Amount")
            {
                Feebox.Text = "";
                Feebox.ForeColor = Color.Black;
            }

        }

        private void Leave_Fee(object sender, EventArgs e)
        {
            if(Feebox.Text == "")
            {
                Feebox.Text = "Please Enter Amount";
                Feebox.ForeColor = Color.Black;
