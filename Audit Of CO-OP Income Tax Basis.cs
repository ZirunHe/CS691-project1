...
{
    public partial class Audit_Of_Co_Op_Income_Tax_Basis : Form
    {
        public Audit_Of_Co_Op_Income_Tax_Basis()
        {
            InitializeComponent();
        }
            ...
            if (MessageBox.Show("Please Confirm the following information is correct ", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                try
                {
                    ...
                    if (RatesYes.Checked && SupplementaryRemove.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Audit Of CO-OP Income Tax Basis\Audit CO-OP-Income_450.docx");
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Audit Of CO-OP Income Tax Basis\Audit CO-OP-Income_450.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    else if (RatesYes.Checked && SupplementaryInclude.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Audit Of CO-OP Income Tax Basis\Audit CO-OP-Income_450_Supplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Audit Of CO-OP Income Tax Basis\Audit CO-OP-Income_450_Supplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    else if (RatesNo.Checked && SupplementaryInclude.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Audit Of CO-OP Income Tax Basis\Audit CO-OP-Income_495_Supplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Audit Of CO-OP Income Tax Basis\Audit CO-OP-Income_495_Supplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    else if (RatesNo.Checked && SupplementaryRemove.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Audit Of CO-OP Income Tax Basis\Audit CO-OP-Income_495.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Audit Of CO-OP Income Tax Basis\Audit CO-OP-Income_495.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
