...
{
    public partial class Review_GAAP_Bsis : Form
    {
        public Review_GAAP_Bsis()
        {
            InitializeComponent();
        }
            ...
            if (MessageBox.Show("Please Confirm the following information is correct ", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                try
                {
                    ...
                    if (RatesYes.Checked && SupplementaryInclude.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Review GAAP Basis\450-Supplementary.docx");
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Review GAAP Basis\450-Supplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    if (RatesNo.Checked && SupplementaryInclude.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Review GAAP Basis\495-Supplementary  .docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Review GAAP Basis\495-Supplementary  .docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    if (RatesOther.Checked && SupplementaryInclude.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Review GAAP Basis\Other-Supplementary .docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Review GAAP Basis\Other-Supplementary .docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    if (RatesYes.Checked && SupplementaryRemove.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Review GAAP Basis\450-NoSupplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Review GAAP Basis\450-NoSupplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    if (RatesNo.Checked && SupplementaryRemove.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Review GAAP Basis\495-NoSupplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Review GAAP Basis\495-NoSupplementary.docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                    ...
                    if (RatesOther.Checked && SupplementaryRemove.Checked)
                    {
                        try
                        {
                            document = application.Documents.Add(Template: @"C:\Users\Will Norales\Downloads\Review GAAP Basis\Other-NoSupplementary .docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
                        ...
                        try
                        {
                            document = application.Documents.Add(Template: @"S:\Shared\wnorales\Review GAAP Basis\Other-NoSupplementary .docx");
                            document.GrammarChecked = true;
                            document.SpellingChecked = true;
                            application.Visible = true;
                        }
        ...
        private void Retainer_Fee(object sender, EventArgs e)
        {
            if (RetainerFeild.Text == "Please Enter Amount")
            {
                RetainerFeild.Text = "";
        ...
        private void Retainer_Leave(object sender, EventArgs e)
        {
            if (RetainerFeild.Text == "")
            {
                RetainerFeild.Text = "Please Enter Amount";
